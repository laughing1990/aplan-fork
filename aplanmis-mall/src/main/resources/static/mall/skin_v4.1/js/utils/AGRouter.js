...
;(function(global,factory,plug){
    ...
    function Router() {
        ...
        this.refresh = function (e) {
            ...
            } else if (e.type == 'load' && /CreditUnitList|declare|scheduleInquire|declareHave|matCompletionList|approve|matSupplementList|lifeCycle|UserInfo|MyHomeIndex|myHomeIndex|MyMaterials|AddProj|MyCertificateLibrary|CreditDetail|withdrawApplyList|drafts|matSupplement|MyProjList|guideList/igm.test(location.hash.slice(1))) {
