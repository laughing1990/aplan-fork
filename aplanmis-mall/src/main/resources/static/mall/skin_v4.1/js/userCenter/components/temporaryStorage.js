    ...
    var myCloundSpaces = new Vue({
        ...
        methods:{
            ...
            getDirTree:function () {
                ...
                vm.mloading = true;
                request('', {
                    url: ctx + 'rest/temporary/root/dir/tree',
                    type: 'get'
                }, function (res) {
                    console.log(res)
                    if(res.success){
            ...
            getFileList:function (itemSub) {
                ...
                request('', {
                    url: ctx + 'rest/temporary/att/list/',
                    type: 'get',
                    data:{
                        dirId:dirId,
                        pageNum:vm.pageNum,
            ...
            sureAddDir:function(){
                ...
                vm.$refs['addDirForm'].validate(function(valid){
                    if (valid) {
                        ...
                        request('', {
                            url: ctx + 'rest/temporary/insertOrUpdateRootDir',
                            type: 'post',
                            data:parmas,
                        }, function (res) {
                            if(res.success){
            ...
            deleteDir:function(){
                ...
                confirmMsg('', '确定要删除吗？', function() {
                    request('bpmAdminUrl', {
                        type: 'get',
                        url: ctx + 'rest/temporary/deleteDirAndFiles/'+  _this.delDirId,
                    }, function(res) {
                        if(res.success){
            ...
            sureReName:function(){
                ...
                if(_this.isReNameFile){
                    request('bpmAdminUrl', {
                        type: 'post',
                        url: ctx + 'rest/temporary/renameCloudFile',
                        data:{
            ...
            uploadCloudFiles:function(){
                ...
                $.ajax({
                    ...
                    url: ctx + 'rest/temporary/uploadCloudFiles',
            ...
            doDownload: function (type, key) {
                ...
                if (type == 0) {
                    var url = ctx + "rest/temporary/att/download?detailIds=" + key;
                    ...
                    if (!key && FilesMultipleSelection.length === 0) {
                        ...
                        var url = ctx + "rest/temporary/att/download?detailIds=" + fileIdsStr; //本地磁盘下载
                        // window.location.href = url;
                        // 转换完成，创建一个a标签用于下载
            ...
            * */
            ...
            sureMoveFile:function(){
                ...
                console.log(params)
                request('', {
                    url: ctx + 'rest/temporary/moveFilesFromDir',
                    type: 'get',
                    data:params,
                }, function (res) {
                    if(res.success){
