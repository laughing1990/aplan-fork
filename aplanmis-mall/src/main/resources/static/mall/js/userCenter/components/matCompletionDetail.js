...
var module1 = new Vue({
  ...
  methods: {
    ...
    lookProjDetail: function () {
      var ts = this;
      ts.mloading = true;
      ts.applyinstCorrectId = pager.applyinstCorrectId;
      request('', {
        url: ctx + 'rest/user/getMatCompCorrectInfo',
        type: 'get',
        data: {
          applyinstCorrectId: ts.applyinstCorrectId
        }
      }, function (res) {
        ts.mloading = false;
        if (res.success) {
    ...
    getApplyObjectInfo: function () {
      ...
      request('', {
        ...
        type: 'get',
        data: {
          applyinstCorrectId: _that.applyinstCorrectId
        }
      }, function (result) {
        if (result.success) {
