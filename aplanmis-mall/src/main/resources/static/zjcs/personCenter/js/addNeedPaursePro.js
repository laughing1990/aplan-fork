...
var module1 = new Vue({
    ...
    // new-采购需求相关
    getAddNeedPaursePandelDom: function(){
      var url = "";
      if (document.location.protocol == "file:") {
          url = './components/owner/needPaurseDetail.html';
      } else {
          url = ctx + '/supermarket/main/needPaurseDetail.html';
      }

      $.get(url, function (result) {
        $('#projNeedpaurseWrap').html(result);
      });
    },
	},
	mounted: function () {
