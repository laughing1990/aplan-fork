  ...
  data: function () {
    return {
      ...
      creditList: [{
        ...
        lcImgUrl: '../../../static/zjcs/index/images/chop_01.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_02.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_02.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_03.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_03.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_04.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_04.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_05.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_05.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_06.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_06.png',
        url: '#'
      }, {
        imgUrl: '/aplanmis-mall/zjcs/index/images/chop_07.png',
        lcImgUrl: '../../../static/zjcs/index/images/chop_07.png',
        url: '#'
      }],
      othersLinkList: [{
        label: '—— 各级政府 ——',
      ...
      // 信用公示列表
      creditPublicityList: [
        {name: '天津市路驰建设工程监理有限公司',publishNumber: '1'},
        {name: '广东胜力检测鉴定有限公司',publishNumber: '3'},
