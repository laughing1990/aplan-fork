...
public class RestParallerApplyServiceImpl implements RestParallerApplyService {
    ...
    @Override
    public ItemListVo listItemAndStateByStageId(String stageId, String projInfoId, String regionalism) throws Exception {
        ...
        //并联
        List<ParallelApproveItemVo> paraItemList = this.getRequiredItems(stageId, projInfoId, regionalism);
        //并行
        List<ParallelApproveItemVo> coreItemList = this.getOptionalItems(stageId, projInfoId, regionalism);
     ...
     */
    public List<ParallelApproveItemVo> getRequiredItems(String stageId, String projInfoId, String regionalism) throws Exception {
        ...
        return postHandle(coreItems, stageId, "0", regionalism);
    }
     ...
     * @param projInfoId 项目id
     */
    public List<ParallelApproveItemVo> getOptionalItems(String stageId, String projInfoId, String regionalism) throws Exception {
        ...
        return postHandle(optionItems, stageId, "1", regionalism);
    }
     ...
     */
    private List<ParallelApproveItemVo> postHandle(List<AeaItemBasic> aeaItemBasics, String stageId, String isOptionItem, String regionalism) throws Exception {
        AeaParStage aeaParStage = aeaParStageMapper.getAeaParStageById(stageId);
        ...
        return resultItems.stream().filter(CommonTools.distinctByKey(AeaItemBasic::getItemVerId)).map(ParallelApproveItemVo::build).peek(vo -> {
            ...
            if ("1".equals(flag)) {//标准事项
                List<AeaItemBasic> sssxList = aeaItemBasicService.getSssxByItemIdAndRegionalism(vo.getItemId(), regionalism, null, SecurityContext.getCurrentOrgId());
