package com.augurit.aplanmis.integration.license.utils;
...
public class ConnectionHelper {
     ...
     * @return
     */
    public static String doPost2(String url, Map<String, String> params, String data, Map<String, String> headMap) {
        if (StringUtils.isBlank(url)) {
            logger.debug("url is null！");
            return null;
        }
    ...
    public static String doPost(String url, Map<String, String> params, Object data, Map<String, String> headMap) {
        ...
        return ConnectionHelper.doPost2(url, params, jsonStr, headMap);
    ...
    public static String calcRequestSign(String timestamp, String paasToken, String nonce) throws Exception {
        ...
        return toSHA256(String.format("%s%s%s%s", timestamp, paasToken, nonce, timestamp)).toUpperCase();
    }
