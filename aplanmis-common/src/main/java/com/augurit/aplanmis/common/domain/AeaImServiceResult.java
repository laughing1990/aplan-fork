...
public class AeaImServiceResult implements Serializable {
    ...
    public void buildModifyResult(String auditFlag, String creater) {
    ...
    //创建新增参数
    public void createResult(String projPurchaseId, String unitBiddingId, String auditFlag, String creater, String rootOrgId) {
        this.serviceResultId = UUID.randomUUID().toString();
