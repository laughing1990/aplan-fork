...
public class OneFormCommonController {
    ...
    @ApiOperation("根据参数获取一张表单的多个form的html片段，该片段用于填充到dom容器")
    public ContentResultForm<String> renderFormsHtmlPost(OneFormStageRequest oneFormStageRequest,SFRenderConfig sFRenderConfig) {
