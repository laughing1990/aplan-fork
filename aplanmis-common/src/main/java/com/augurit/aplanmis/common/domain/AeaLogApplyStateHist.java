...
@Data
public class AeaLogApplyStateHist implements Serializable {

    private static final long serialVersionUID = 1L;

    private String stateHistId; // (主键)
    private String applyinstId; // (事项实例（办件）ID)
    ...
    //额外字段
    private String applyinstSource;//申请实例来源，theme统计使用到
}
