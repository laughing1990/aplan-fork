 ...
 */
@Data
public class AeaAnaWinMonthStatistics implements Serializable {

    private static final long serialVersionUID = 1L;
    private String windowMonthStatisticsId; // (主键)
    ...
    @Size(max = 4)
    private Double supplementedOnYoyBasis; // (月补全待确认数同比)
    @Size(max = 4)
    private Double supplementedLrr; // (月补全待确认数环比)
    @Size(max = 10)
