...
public interface AeaProjInfoService {
     ...
     * @return
     */
    List<AeaProjInfo> findRootAeaProjInfoByLinkmanInfoId(String linkmanInfoId,String keyword) throws Exception;

    /**
     * 通过单位id获取项目信息
     */
    List<AeaProjInfo> findRootAeaProjInfoByUnitInfoId(String unitInfoId,String keyword) throws Exception;
     ...
     * @return
     */
    List<AeaProjInfo> findRootAeaProjInfoByLinkmanInfoIdAndUnitInfoId(String linkmanInfoId, String unitInfoId,String keyword) throws Exception;
    ...
    List<AeaProjInfo> findAeaProjInfoByUserPrev(String keyWord, String unitInfoId, String linkmanInfoId);
}
