...
import java.util.List;
    ...
    */
    ...
    public void insertAeaHiItemCorrect(AeaHiItemCorrect aeaHiItemCorrect) throws Exception;
    public void updateAeaHiItemCorrect(AeaHiItemCorrect aeaHiItemCorrect) throws Exception;
    public void deleteAeaHiItemCorrect(@Param("id") String id) throws Exception;
    public List <AeaHiItemCorrect> listAeaHiItemCorrect(AeaHiItemCorrect aeaHiItemCorrect) throws Exception;
    public AeaHiItemCorrect getAeaHiItemCorrectById(@Param("id") String id) throws Exception;
