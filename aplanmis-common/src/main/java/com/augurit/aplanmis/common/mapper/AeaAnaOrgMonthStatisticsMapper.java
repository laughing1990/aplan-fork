...
public interface AeaAnaOrgMonthStatisticsMapper {
    ...
    void insertAeaAnaOrgMonthStatistics(AeaAnaOrgMonthStatistics aeaAnaOrgMonthStatistics);

    void updateAeaAnaOrgMonthStatistics(AeaAnaOrgMonthStatistics aeaAnaOrgMonthStatistics);

    void deleteAeaAnaOrgMonthStatistics(@Param("id") String id);

    List<AeaAnaOrgMonthStatistics> listAeaAnaOrgMonthStatistics(AeaAnaOrgMonthStatistics aeaAnaOrgMonthStatistics);

    AeaAnaOrgMonthStatistics getAeaAnaOrgMonthStatisticsById(@Param("id") String id);

    void deleteThisMonthStatisticsData(@Param("statisticsMonth") String statisticsMonth, @Param("rootOrgId") String rootOrgId);

    void batchInserOrgMonthStatisticst(@Param("orgMonthStatisticsList") List<AeaAnaOrgMonthStatistics> orgMonthStatisticsList);

    AeaAnaOrgMonthStatistics getAeaAnaOrgMonthStatistics(@Param("orgId") String orgId, @Param("itemId") String itemId, @Param("applySource") String applySource, @Param("statisticsMonth") String statisticsMonth);

    List<AeaAnaOrgMonthStatistics> queryAeaAnaOrgMonthStatistics(@Param("orgId") String orgId, @Param("itemId") String itemId, @Param("applySource") String applySource, @Param("monthList") List<String> monthList);
     ...
     * @return
     */
    List<AeaAnaOrgMonthStatistics> getRegionAcceptStatistics(@Param("month") String month, @Param("rootOrgId") String rootOrgId);
