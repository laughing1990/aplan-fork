 ...
 */
@Data
public class AeaAnaThemeDayStatistics implements Serializable {
// ----------------------------------------------------- Properties

    private static final long serialVersionUID = 1L;
    private String themeDayStatisticsId; // (主键)
    ...
    @Size(max = 10)
    private Long dayApplyCount; // (日接件数（需查询历史表统计）)
    @Size(max = 10)
