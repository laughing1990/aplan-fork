...
var vm = new Vue({
    ...
    methods: {
        ...
        queryReceiveList: function (applyinstIds) {
            ...
            request('', {
                url: ctx + 'rest/receive/getAeaHiReceiveByApplyinstIds',
                type: 'get',
                /*ContentType: 'application/json',
                data: JSON.stringify({'applyinstIds':applyinstId})*/
                //data: {'applyinstIds': applyinstId}
        ...
        //格式化回执类型
        formatReceiveType: function (row, column, cellValue, index) {
            var value = '收件回执';
            switch (cellValue) {
                case '1':
                    value = '收件回执';
