  ...
  methods: {
    ...
    guideSaveItems: function (visibleKey, cb, state) {
      ...
      this.parallelItems.concat(this.coreItems).forEach(function (u) {
        ...
        if (vm.approveDept && _itemIds.indexOf(itemVerId) != -1) {
          // 审批部门
    ...
    requestGuideData: function (guideId) {
      ...
      request('', {
        ...
        if (res.success) {
          ...
          vm.approveDept = !!vm.guideDetail.approveItemVerIds.length;
        ...
        if (data.success) {
          ...
          if (_that.isGuidePage) { // 部门辅导
            if (!_that.guideChangedType) {
              ...
              _coreItems.forEach(function (u) {
                setParam1(u);
              });
              _parallelItems.forEach(function (u) {
                setParam1(u);
              });
              ...
              function setParam1(u) {
                ...
                if (
                  ...
                  if (vm.leaderDept && (vm.guideState < 3 || vm.guideState == 6)) {
                    // 牵头部门人员
                    vm.$set(u, 'bmDisabled', false);
                    if (vm.guideState < 3) {
                      // 牵头部门待处理，默认和用户勾选一致
