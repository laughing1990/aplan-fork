var vm = new Vue({
	...
	methods: {
		...
		viewDetail: function (row) {
			var url = ctx + 'apanmis/page/stageApproveIndex?taskId=' + row.taskId + '&viewId=' + row.viewId + '&itemNature=' + row.itemNature + '&busType=yjzq&isNotCompareAssignee=true';
			if (row.busRecordId) {
			...
			request('bpmFrontUrl', {
				...
				if (result.success) {
					...
					window.setTimeout(function () {
						window.open(ctx + 'apanmis/page/stageApproveIndex?taskId=' + row.taskId + '&viewId=' + row.viewId + '&busRecordId=' + row.busRecordId + '&itemNature=' + row.itemNature + '&busType=yjzq&isNotCompareAssignee=true', '_blank');
