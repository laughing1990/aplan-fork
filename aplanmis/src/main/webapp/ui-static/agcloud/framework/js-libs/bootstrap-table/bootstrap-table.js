...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        treePagination:false,       //treegrid 分页
        treeAllRows:10,             //分页的总记录数
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (this.options.sidePagination !== 'server') {
            if(this.options.treePagination){         //如果是treegrid分页 则总记录数参数使用传递的数值
                this.options.totalRows = this.options.treeAllRows;
            }else{
