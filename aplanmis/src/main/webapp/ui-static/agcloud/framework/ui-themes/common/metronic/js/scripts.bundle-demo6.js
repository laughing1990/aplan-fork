            ...
            var n = {
                isInit: !1, offset: 110, stateId: "meta", ajaxParams: {}, init: function (e) {
                    ...
                    var o = {
                        ...
                        init: function () {
                            mUtil.isRTL() && t.fn.extend({
                                scrollRight: function (t) {
                                    return void 0 === t ? this[0].scrollWidth - (this[0].scrollLeft + this[0].clientWidth) + 1 : this.scrollLeft(this[0].scrollWidth - this[0].clientWidth - t)
                                }
                            });
                        ...
                        onScrolling: function (e) {
                            ...
                            if (mUtil.isRTL()) {
                                ...
                                t(o.scrollHead).css("right", -n), t(o.scrollFoot).css("right", -n)
                            } else {
                                var i = t(this).scrollLeft();
                                t(o.scrollHead).css("left", -i), t(o.scrollFoot).css("left", -i)
                            }
                    ...
                    if (t = n.getTablePrefix(t), !1 !== n.getOption("data.saveState")) {
                        var a = null;
                        return null != (a = n.getOption("data.saveState.webstorage") && localStorage ? localStorage.getItem(t) : Cookies.get(t)) ? JSON.parse(a) : void 0
                    }
                    ...
                    void 0 === e.detail && 1 === n.getDepth() && (mUtil.isRTL() ? t(a.table).find(".m-datatable__row").css("right", 0) : t(a.table).find(".m-datatable__row").css("left", 0), t(a.table).find(".m-datatable__lock").css("top", 0), t(a.tableBody).scrollTop(0))
                    ...
                    return n.isLocked() ? n.nodeTr = n.recentNode = t(a.tableBody).children().first().find(e).filter(".m-datatable__row") : n.nodeTr = n.recentNode = t(a.tableBody).find(e).filter(".m-datatable__row"), a
                }, column: function (e) {
                    return n.isLocked() ? n.nodeCols = n.recentNode = t(a.tableBody).children().first().find(".m-datatable__cell:nth-child(" + (e + 1) + ")") : n.nodeCols = n.recentNode = t(a.tableBody).find(".m-datatable__cell:nth-child(" + (e + 1) + ")"), a
                }, columns: function (e) {
                    var o = a.table;
...
var mLayout = function () {
    ...
    return {
        init: function () {
            ...
            var n, i, l, r, s, d, c, m;
            l = mUtil.get("body"), r = mUtil.get("m_aside_left"), s = mUtil.hasClass(r, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
                baseClass: s,
                overlay: !0,
                ...
                i && (clearTimeout(i), i = null), n = setTimeout(function () {
                    mUtil.hasClass(l, "m-aside-left--minimize") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(l, "m-aside-left--minimize"), mUtil.addClass(l, "m-aside-left--minimize-hover"), e.scrollerUpdate(), e.scrollerTop())
                }, 300)
            }), mUtil.addEvent(r, "mouseleave", function () {
                n && (clearTimeout(n), n = null), i = setTimeout(function () {
                    mUtil.hasClass(l, "m-aside-left--minimize-hover") && mUtil.isInResponsiveRange("desktop") && (mUtil.removeClass(l, "m-aside-left--minimize-hover"), mUtil.addClass(l, "m-aside-left--minimize"), e.scrollerUpdate(), e.scrollerTop())
                }, 500)
                ...
                scroll: d,
                submenu: {
                    desktop: {default: m, state: {body: "m-aside-left--minimize", mode: "dropdown"}},
                    tablet: "accordion",
                    mobile: "accordion"
                },
