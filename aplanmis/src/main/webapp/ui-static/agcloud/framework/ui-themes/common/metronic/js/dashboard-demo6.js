                        ...
                        !function() {
                            if (0 != $("#m_chart_personal_income_quater_2").length) {
                                ...
                                e.on("draw", function(e) {
                                    ...
                                    e.on("created", function() {
                                        window.__anim212789071241111 && (clearTimeout(window.__anim212789071241111),
                                            window.__anim212789071241111 = null),
                                            window.__anim212789071241111 = setTimeout(e.update.bind(e), 15e3)
                                    })
                            }
                        }();
                        break;
    ...
    return {
        init: function() {
            ...
            0 != $("#m_chart_profit_share").length && new Chartist.Pie("#m_chart_profit_share",{
                ...
                function() {
                    if (0 != $("#m_chart_latest_trends_map").length)
                        try {
                            new GMaps({
            ...
            0 != $("#m_chart_support_tickets2").length && new Chartist.Pie("#m_chart_support_tickets2",{
                ...
                function() {
                    ...
                    function r(t, a, r) {
                        var o = ""
                            , n = "";
                        a - t < 100 || "Today" == r ? (o = "Today:",
                            n = t.format("MMM D")) : "Yesterday" == r ? (o = "Yesterday:",
                            n = t.format("MMM D")) : n = t.format("MMM D") + " - " + a.format("MMM D"),
                            e.find(".m-subheader__daterange-date").html(n),
                            e.find(".m-subheader__daterange-title").html(o)
                    }
                }(),
