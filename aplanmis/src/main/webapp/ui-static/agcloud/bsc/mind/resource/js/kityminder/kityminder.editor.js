...
_p[15] = {
    value: function(require, exports, module) {
        function NodeRuntime() {
                ...
                main.button({
                    ...
                    action: function() {
                        if (command.indexOf("Append") === 0) {
                            ...
                            handleRelAppend(minder,command);
            ...
            function handleRelAppend(minder,command){
                ...
                if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_STAGE){
                    data.text='情形';
                    data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_SITUATION;
                    minder.execCommand(command, data);
                }
                ...
                else if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_SITUATION){
                    data.text='情形';
                    data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_SITUATION;
                    minder.execCommand(command, data);
                }
                else if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_MAT){
                    agcloud.ui.metronic.showSwal({type: 'info', message: '该节点不支持添加情形!'});
                }
                else if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_CERT){
                    agcloud.ui.metronic.showSwal({type: 'info', message: '该节点不支持添加情形!'});
                }
            }
        }
        ...
        return {
            ...
            link: function($scope) {
                ...
                $scope.execCommand = function(command) {
                    var currentNode=minder.getSelectedNode();
                    var currentData=currentNode.data;
                    // $('#m-modal-electronic-parts').modal('show');
                    var data={};
                    data.operatorTag=MindConst_MIND_NODE_OPERATOR_TAG_NEW;
                    ...
                    if(currentBusiScene==BUSI_SCENE_CONFIG_SITUATION){
                        if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_STAGE){
                            data.text='情形';
                            data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_SITUATION;
                            execCommandAndEdit(minder,command,data);
                        }
                        else if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_ITEM){
                            data.text='情形';
                            data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_SITUATION;
                        ...
                        if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_ITEM){
                            data.text='条件';
                            data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_CONDTION;
                            execCommandAndEdit(minder,command,data);
                        }
                        else if(currentData.nodeTypeCode==AeaMindConst_MIND_NODE_TYPE_CODE_CONDTION){
                            data.text='条件';
                            data.nodeTypeCode=AeaMindConst_MIND_NODE_TYPE_CODE_CONDTION;
                            execCommandAndEdit(minder,command,data);
                        }
                ...
                function execCommandAndEdit(minder,command,data) {
                    minder.execCommand(command, data);
                    editText();
                }
                function editText() {
