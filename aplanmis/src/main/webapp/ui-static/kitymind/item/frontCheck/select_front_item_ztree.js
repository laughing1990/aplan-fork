...
function initSelectItemZtree(){
    ...
    $.ajax({
        url: ctx+'/aea/item/getUnSelectedItemFrontItemTree.do',
        type:'post',
        data:{itemVerId:currentBusiId,frontItemId:frontItemId},
        async: false,
        dataType: 'json',
...
function batchImportItemFrontItem(){
    selectItemTreeSetting.check={
        enable: true,
        chkStyle: "checkbox",
        chkboxType: { "Y": "", "N": "" }
...
function batchSaveItemFrontItem(nodes) {
    ...
    $.ajax({
        url: ctx+'/aea/item/front/item/batchSaveAeaItemFrontItem.do',
        type:'post',
        data:{itemVerId:currentBusiId,frontCkItemVerIds:itemVerIds.join(",")},
        async: false,
        dataType: 'json',
