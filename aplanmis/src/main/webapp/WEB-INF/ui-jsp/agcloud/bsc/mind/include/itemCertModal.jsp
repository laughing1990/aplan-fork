...
<div id="cert_import_modal" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 1000px;">
        <div class="modal-content">
            ...
            <div id="certDiv" class="m-portlet__body"  style="padding: 5px 0px;">
                        ...
                        <div class="col-xl-6" style="padding: 0px 2px 0px 8px;">
                            <div class="m-portlet" style="margin-bottom: 0px;width: 100%;height: 100%;">
                                ...
                                <div class="m-portlet__body" style="padding: 10px 0px;">
                                    ...
                                    <div id="selectCertTree" class="ztree" style="height: 380px;
                                         overflow-y:auto;overflow-x:auto;"></div>
                                </div>
                            </div>
                        </div>
...
var selectCertKey,
    ...
    function getCertChoose(){

        var linkMatArr = [];
        $("li[name='selectCertLi']").each(function(){
            var globalMat = new Object();
            globalMat.id = $(this).attr("category-id");
            globalMat.name = $(this).find("span").eq(1).text();
