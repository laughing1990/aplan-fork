    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 class="modal-title" id="aedit_solicit_org_modal_title">编辑牵头部门</h5>
            ...
            <form id="aedit_solicit_org_form" method="post">
                <div class="modal-body" style="padding: 10px;">
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-lg-2 col-form-label" style="text-align: right;">牵头部门名称:</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-lg-2 col-form-label" style="text-align: right;">牵头部门编号:</label>
                        <div class="col-lg-10">
