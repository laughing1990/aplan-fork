                            ...
                            <div class="m-radio-inline">
                                <c:forEach items="${solicitBusTypes}" var="solicitBusType">
                                    <c:if test="${solicitBusType.itemCode!='LHPS'&&solicitBusType.itemCode!='YCZX'}">
                                        <label class="m-radio">
                                            <input type="radio" name="busType" value="${solicitBusType.itemCode}" onclick="changeBusType(this, '#aedit_solicit_item_form', '${solicitBusType.itemName}');">${solicitBusType.itemName}<span></span>
                                        </label>
                                    </c:if>
                                </c:forEach>
                            </div>
