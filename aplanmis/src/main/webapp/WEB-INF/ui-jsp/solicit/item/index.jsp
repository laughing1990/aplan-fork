...
<div id="solicitItemContextMenu" class="contextMenuDiv">
    <a href="javascript:void(0);" class="list-group-item" onclick="editSolicitItemById2();">
        <i class="fa flaticon-edit-1"></i>编辑
    </a>
    <a href="javascript:void(0);" class="list-group-item" onclick="deleteSolicitItemById2();">
