        ...
        <div class="m-portlet" style="margin-bottom: 0px;width: 100%;height: 100%;">
            ...
            <div class="m-portlet__body" style="padding: 10px 0px;">
                <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 10px;">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#m_tabs_1" onclick="clearSearchSolicitItemList();">
                            <i class="la la-gear"></i>
                            征求事项
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#m_tabs_2" onclick="clickToLoadSolicitItemUser()">
                            <i class="la la-gear"></i>
                            征求人员
                        </a>
                    </li>
                                ...
                                <div class="m-form m-form--label-align-right m--margin-bottom-5">
                                    <div class="row" style="margin: 0px;">
                                        <div class="col-md-6" style="text-align: left;">
                                            ...
                                            <button type="button" class="btn btn-secondary"
                                                    onclick="refreshSolicitItemList();">刷新</button>
                                        </div>
                                        <div class="col-md-6" style="padding: 0px;">
                                            <form id="search_solicit_item_form" method="post">
                                                <div class="row" style="margin: 0px;">
                                                    <div class="col-5"></div>
                                                    ...
                                                    <div class="col-3" style="text-align: center;">
                                                        <button type="button" class="btn btn-info"
                                                                onclick="searchSolicitItemList();">查询
                                                        </button>
                                                        <button type="button" class="btn btn-secondary"
                                                                onclick="clearSearchSolicitItemList();">清空
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="col-xl-4" style="padding: 0px 2px 0px 8px;">
                                <div class="m-portlet" style="margin-bottom: 0px;width: 100%;height: 100%;">
                                    <div class="m-portlet__body" style="padding: 10px 0px;">
                                        <div class="row" style="margin: 0px;">
                                            <div class="col-xl-5">
                                                <input id="selectSolicitItem2KeyWord" type="text"
                                                       class="form-control m-input m-input--solid empty" placeholder="请输入关键字..."
                                                       style="background-color: #f0f0f075;border-color: #c4c5d6;">
                                            </div>
                                            <div class="col-xl-7">
                                                <button type="button" class="btn btn-info"
                                                        onclick="searchSelectSolicitItem2Node();">查询</button>
                                                <button type="button" class="btn btn-secondary"
                                                        onclick="clearSearchSelectSolicitItem2Node();">清空</button>
                                                <button type="button" class="btn btn-secondary"
                                                        onclick="expandSelectSolicitItem2AllNode();">展开</button>
                                                <button type="button" class="btn btn-secondary"
                                                        onclick="collapseSelectSolicitItem2AllNode();">折叠</button>
                                            </div>
                                        </div>
                                        <div style="margin: 5px 0px;border-bottom: 1px solid #e8e8e8;"></div>
                                        <div id="selectSolicitItem2Tree" class="ztree" style="overflow: auto;"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-8" style="padding: 0px 8px 0px 2px;">
                                <div class="m-portlet" style="margin-bottom: 0px;width: 100%;height: 100%;">
                                    <div class="m-portlet__body" style="padding: 10px 0px;">
                                        <div class="m-form m-form--label-align-right m--margin-bottom-5">
                                            <div class="row" style="margin: 0px;">
                                                <div class="col-md-6" style="text-align: left;">
                                                    ...
                                                    <button type="button" class="btn btn-secondary"
                                                            onclick="batchDelSolicitItemUser();">批量移除</button>
                                                    <%--<button type="button" class="btn btn-secondary"--%>
                                                    <%--onclick="sortSolicitItemUser();">排序</button>--%>
                                                    <button type="button" class="btn btn-secondary"
                                                            onclick="refreshSolicitItemUserList();">刷新</button>
                                                </div>
                                                <div class="col-md-6" style="padding: 0px;">
                                                    <form id="search_solicit_item_user_form" method="post">
                                                        <div class="row" style="margin: 0px;">
                                                            ...
                                                            <div class="col-4" style="text-align: center;">
                                                                <button type="button" class="btn btn-info"
                                                                        onclick="searchSolicitItemUserList();">查询
                                                                </button>
                                                                <button type="button" class="btn btn-secondary"
                                                                        onclick="clearSearchSolicitItemUserList();">清空
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </form>
                                        ...
                                        <div style="margin: 5px 0px;border-bottom: 1px solid #e8e8e8;"></div>
                                        <div class="base" style="padding: 5px">
                                            <table id="solicit_item_user_list_tb"></table>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- 新增/编辑征求事项 -->
<%@include file="aedit_solicit_item.jsp" %>
