...
<head>
    ...
    <%--<link rel="stylesheet" href="${pageContext.request.contextPath}/agcloud/framework/js-lib/agcloud-lib/css/reset.css">--%>
            ...
            <div class="m-portlet__body" style="padding: 10px 0px;">
                ...
                <div id="tabePanel" class="base" style="padding: 10px;overflow: auto">
                    ...
                    <el-table :data="processTableData" row-key="id" :indent="indent" border class="scrollable"
                        ...
                        <el-table-column prop="operate_" width="350" label="操作" align="left">
                            <template slot-scope="scope">
