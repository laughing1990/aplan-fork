...
<!-- 添加/编辑 -->
<div id="edit_par_front_item_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="dialog_item_dept" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            <!-- 标题 -->
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 class="modal-title" id="edit_par_front_item_title">事项信息前置检测</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="edit_par_front_item_form" method="post">
                <div class="modal-body" style="padding: 10px;">
                    <div id="edit_par_front_item_scroll" style="height: 250px;overflow-x: hidden;overflow-y: auto;">

                        <input type="hidden" name="frontItemId" id="frontItemId" value=""/>
                        <input type="hidden" name="stageId" value=""/>
                        <input type="hidden" name="itemVerId" id="frontItemVerId" value=""/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-10">
                                <textarea type="text" class="form-control m-input" name="itemName" rows="3" readonly value=""></textarea>
                            </div>
                        </div>
                ...
                <div class="modal-footer" style="padding: 10px;height: 60px;">
                    <button type="submit" class="btn btn-info" id="saveParFrontItemBtn" style="display: ${curIsEditable?'':'none'}">保存</button>
