    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document" style="max-width: 650px;">
        <div class="modal-content">
            ...
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 class="modal-title" id="edit_par_front_partform_title">阶段扩展表单前置检测</h5>
            ...
            <form id="edit_par_front_partform_form" method="post">
                <div class="modal-body" style="padding: 10px;">
                    <div id="edit_par_front_partform_scroll" style="height: 400px;overflow-x: hidden;overflow-y: auto;">
                        ...
                        <input type="hidden" name="stagePartformId" id="stagePartformId" value=""/>
                ...
                <div class="modal-footer" style="padding: 10px;height: 60px;">
                    <button type="submit" class="btn btn-info" id="saveParFrontPartformBtn">保存</button>
