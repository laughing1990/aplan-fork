...
<!-- 分类排序 -->
<div id="sort_par_front_partform_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="sort_par_front_partform_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 10px;">
                <div id="sortParFrontPartformDiv" style="max-height:500px; overflow:auto;">
                    <div class="opusOmSortDiv">
                        <ul id="sortParFrontPartformUl" class="block_ul_td"></ul>
                    </div>
                </div>
            </div>
            <div class="modal-footer" style="padding: 10px;height: 60px;">
                <button type="button" class="btn btn-secondary"
                        onclick="$('#sort_par_front_partform_modal').modal('hide');">关闭</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#sortParFrontPartformDiv').niceScroll({
        ...
        Sortable.create(document.getElementById('sortParFrontPartformUl'), {
            animation: 150,
            //拖拽完毕之后发生该事件
            onEnd: function (evt) {
                var liObjs = document.getElementsByName('sortParFrontPartformLi');
                var ids = [];
                var sortNos = [];
                if(liObjs!=null&&liObjs.length>0) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: ctx+'/aea/par/front/partform/updateAeaParFrontPartformSortNos.do',
                        dataType: 'json',
                        data: {
                            'ids': ids.toString(),
