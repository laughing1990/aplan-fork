...
<div id="select_partform_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="select_partform_body" aria-hidden="true">
...
<script type="text/javascript">
    ...
    function openSelectItemFrontPartform(){
    ...
    function initSelectPartformTable() {
        ...
        ],ctx + '/aea/item/front/partform/listItemNoSelectPartformByPage.do');
        var select_partform_tb_params = {
    ...
    function batchSaveFrontPartform() {
        ...
        if(rows!=null&&rows.length>0){
            ...
            for(var i=0;i<rows.length;i++){
                ids.push(rows[i].itemPartformId);
            }
