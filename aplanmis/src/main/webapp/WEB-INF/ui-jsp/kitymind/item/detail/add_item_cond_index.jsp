        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 10px;">
                <form id="add_item_cond_form" method="post">
                    ...
                    <div class="form-group m-form__group row" >
                        <label class="col-lg-2 col-form-label" style="text-align: right;"><font color="red">*</font>是否启用<br/>EL表达式:</label>
                        <div class="col-lg-10">
                    ...
                    <div id="condElDiv" class="form-group m-form__group row" >
                        <label class="col-lg-2 col-form-label" style="text-align: right;">
                            <font color="red">*</font>表达式:<br/>
                            <button type="button" class="btn btn-info" onclick="openSelectMetaDbTbcolModal('isCond');"
                    ...
                    <div class="form-group m-form__group row" >
                        <label class="col-lg-2 col-form-label" style="text-align: right;"><font color="red">*</font>条件类型:</label>
                        <div class="col-lg-10">
                            <select id="isAccept" type="text" class="form-control" name="isAccept" value="">
                                <option value="">请选择</option>
                                <option value="1">受理</option>
                                <option value="0">不受理</option>
                            </select>
                        </div>
                    </div>

                    <div id="noAcceptDemoDiv" class="form-group m-form__group row" >
                        <label class="col-lg-2 col-form-label" style="text-align: right;"><font color="red">*</font>不受理原因:</label>
                        <div class="col-lg-10">
                            <textarea id="noAcceptDemo" class="form-control" name="noAcceptDemo" rows="3"></textarea>
                        </div>
                    </div>
