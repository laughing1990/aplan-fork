...
<head>
    ...
    <script src="${pageContext.request.contextPath}/ui-static/aplanmis/item/ui-js/set_item_oneForm_index.js" type="text/javascript"></script>
    <style type="text/css">
        .row{
            display: -ms-flexbox;
            overflow-x: hidden;
...
<jsp:include page="../../mindHeader.jsp"></jsp:include>
    ...
    <!-- 编辑总表 -->
    <%@include file="aedit_item_oneform.jsp"%>
    ...
    <!-- 扩展表排序 -->
    <%@include file="item_partform_sort.jsp"%>

    <!-- 为扩展表导入表单 -->
    <%@include file="import_item_partform_form.jsp"%>
