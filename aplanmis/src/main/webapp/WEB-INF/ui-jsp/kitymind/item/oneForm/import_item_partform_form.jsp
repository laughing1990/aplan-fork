...
<div id="import_partform_form_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="import_partform_form_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 class="modal-title" id="import_partform_form_modal_title">导入表单</h5>
                            ...
                            <div class="row" style="margin: 0px;">
                                <div class="col-7">
                                    <div class="m-input-icon m-input-icon--left">
                                        <input id="partformFormKeyword" type="text" class="form-control m-input"
...
<script type="text/javascript">
            ...
            if(rows!=null&&rows.length>0) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.success) {
                            $('#import_partform_form_modal').modal('hide');
                            swal({
                                text: '保存成功！',
                                type: 'success',
                                timer: 1500,
    ...
    //参数设置
    function partformFormParam(params) {
