                    ...
                    <div id="edit_item_front_item_scroll" style="height: 300px;overflow-x: hidden;overflow-y: auto;">
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label" style="text-align: right;">
                                ...
                                <button ${curIsEditable?'':'disabled'} type="button" class="btn btn-info" onclick="openSelectFrontItemZtree('frontCkItemVerId','frontCkItemName','frontItemId');" style="margin-top: 10px;">选择</button>
                            </label>
                            <div class="col-lg-9">
