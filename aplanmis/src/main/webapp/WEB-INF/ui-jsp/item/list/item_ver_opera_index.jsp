...
<div id="item_ver_opera_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="add_theme_opera_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 class="modal-title" id="item_ver_opera_modal_title">帮助指引</h5>
            ...
            <div class="modal-body" style="padding: 10px 30px;">
                ...
                <p style="font-size: 15px;">5、【复制创建】：点击此按钮将复制当前事项相关配置数据并创建一个新的事项,适用于一个标准事项下存在多个相似的实施事项相关配置；</p>
                <p style="font-size: 15px;">6、【版本状态】：未发布 --> ( 试运行/发布 ) --> 已过时。</p>
            </div>
            <div class="modal-footer" style="padding: 10px;height: 60px;">
                <button type="button" class="btn btn-secondary" onclick="$('#item_ver_opera_modal').modal('hide');">关闭</button>
            </div>
        </div>
    </div>
</div>