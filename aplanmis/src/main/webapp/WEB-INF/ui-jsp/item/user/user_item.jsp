...
<div id="mainContentPanel" class="row" style="width: 100%;height: 99%;padding: 15px 10px 5px 10px;margin: 0px;">
    <!-- 用户事项 -->
    <div id="westPanel" class="col-xl-12" style="padding: 0px 2px 0px 2px;">
                ...
                <div class="m-form m-form--label-align-right m--margin-bottom-5">
                    <div class="row" style="margin: 0px;">
                        <div class="col-md-6" style="text-align: left;">
                            <%--<button type="button" class="btn btn-info" onclick="batchDelUserItem();">批量移除</button>--%>
                            <%--<div class="btn-group m-btn-group" role="group">--%>
                                ...
                                <%--</div>--%>
                            <%--</div>--%>
                            <button type="button" class="btn btn-info" onclick="syncLocalAeaItemGuide();">同步本地指南</button>
                            <button type="button" class="btn btn-secondary" onclick="refreshAllItemList();">刷新</button>
                        </div>
                            ...
                            <form id="search_all_item_list_form" method="post">
                                <div class="row" style="margin: 0px;">
                                    ...
                                    <div class="col-3" style="text-align: center;">
                                        <button type="button" class="btn btn-info" onclick="searchAllItemList();">查询
                                        </button>
...
<script src="${pageContext.request.contextPath}/ui-static/item/user/user_item.js" type="text/javascript"></script>
