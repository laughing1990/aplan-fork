            ...
            <form id="aedit_item_form" method="post" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 10px;">
                    <div id="aedit_item_scroll" style="height: 500px;overflow-x: hidden;overflow-y: auto;">
                        ...
                        <input type="hidden" name="itemExchangeWay" value=""/>
                        ...
                        <div class="form-group m-form__group row" >
                            ...
                            <label class="col-lg-2 col-form-label" style="text-align: right;"><font color="red">*</font>事项性质:</label>
                            <div class="col-lg-4">
                                <select type="text" class="form-control" name="itemNature" value="">
