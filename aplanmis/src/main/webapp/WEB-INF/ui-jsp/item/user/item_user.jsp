                ...
                <div class="m-form m-form--label-align-right m--margin-bottom-5">
                    <div class="row" style="margin: 0px;">
                        <div class="col-md-4" style="text-align: left;">
                            <%--<button type="button" class="btn btn-info"--%>
                                    <%--onclick="addItemInfo(true, true);">新增标准</button>--%>
                            <%--<button id="zjsssx" type="button" class="btn btn-info"--%>
                                    <%--onclick="addItemInfo(true, false);">新增实施</button>--%>
                            <button type="button" class="btn btn-info"
                            ...
                            <div class="btn-group m-btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <a class="dropdown-item" href="#" onclick="addItemInfo(true, true);">
                                        <i class="la la-file-text-o"></i>新增标准
                                    </a>
                                    <a id="zjsssx" class="dropdown-item" href="#" onclick="addItemInfo(true, false);">
                                        <i class="la la-file-text-o"></i>新增实施
                                    </a>
                                    <%--<a class="dropdown-item" href="#" onclick="importUserItem();">--%>
                                        <%--<i class="la la-file-text-o"></i>导入事项--%>
                                    <%--</a>--%>
