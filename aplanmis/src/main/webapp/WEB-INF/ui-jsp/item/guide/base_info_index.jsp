...
<body>
                                ...
                                <div class="row" style="margin: 0px;">
                                    ...
                                    <div class="col-6">
                                        <form id="service_basic_form" method="post">
                                            ...
                                            <%--<input type="hidden" name="tableName" value="AEA_ITEM_VER"/>--%>
                                            <%--<input type="hidden" name="pkName" value="ITEM_VER_ID"/>--%>
    ...
    <script src="${pageContext.request.contextPath}/ui-static/item/guide/base_info_index.js?<%=isDebugMode%>" type="text/javascript"></script>
</body>
</html>