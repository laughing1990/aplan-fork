...
<body>
                ...
                <div class="m-portlet__body" style="padding: 10px 0px;">
                    ...
                    <div class="base" style="padding: 0px 5px;">
                        <table  id="questAnswerTb"
                                ...
                                <%--data-response-handler="questAnswerResponseData"--%>
                                data-url="${pageContext.request.contextPath}/aea/item/guide/listQuestAnswers.do">
                            <thead>
                                <tr>
                                    <th data-field="#" data-checkbox="true" data-align="center"
                                        data-colspan="1" data-width="50"></th>
    ...
    <script src="${pageContext.request.contextPath}/ui-static/item/guide/quest_answer_index.js" type="text/javascript"></script>
</body>
</html>