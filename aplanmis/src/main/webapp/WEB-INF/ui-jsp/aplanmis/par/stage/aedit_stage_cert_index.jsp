...
<style type="text/css">
    ...
    #aedit_stage_cert_scroll::-webkit-scrollbar{
        width:4px;
        height:4px;
    }

    #aedit_stage_cert_scroll::-webkit-scrollbar-track{
        background: #fff;
        border-radius: 2px;
    }

    #aedit_stage_cert_scroll::-webkit-scrollbar-thumb{
        background: #e2e5ec;
        border-radius:2px;
    }

    #aedit_stage_cert_scroll::-webkit-scrollbar-thumb:hover{
        background: #aaa;
    }

    #aedit_stage_cert_scroll::-webkit-scrollbar-corner{
        background: #fff;
    }
</style>

<!-- 新增/编辑阶段证照信息 -->
<div id="aedit_stage_cert_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="aedit_stage_cert_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 id="aedit_stage_cert_modal_title" class="modal-title"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="aedit_stage_cert_form" method="post" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 10px;">
                    <div id="aedit_stage_cert_scroll" style="height: 600px;overflow-x: hidden;overflow-y: auto;">
                        ...
                        <div class="form-group m-form__group row" >
                            ...
                            <div class="col-lg-4 input-group">
                                ...
                                <input type="text" class="form-control m-input" name="attDirName"
                                       placeholder="请点击选择" aria-describedby="select_att_dir" readonly>
                                <div class="input-group-append">
							<span id="select_att_dir" class="input-group-text" onclick="javascript:openSelectBscAttDirModal('modal');">
								选择
							</span>
                                </div>
                            </div>
                ...
                <div class="modal-footer" style="padding: 10px;">
                    ...
                    <button type="button" class="btn btn-secondary"
                            onclick="$('#aedit_stage_cert_modal').modal('hide');">关闭</button>
                </div>
            </form>
        </div>
    </div>
