...
<script type="text/javascript">
    ...
    function clearGuideBasicFile(){
        ...
        $("#guideAttFile").siblings('.custorm-style').find(".right-text").html("");
    ...
    function searchGuideBasicAttSto(type) {
        ...
        commonQueryParams = [];
        commonQueryParams.push({name: "tableName",value:"AEA_PAR_STAGE_GUIDE"});
        commonQueryParams.push({name: "pkName",value: type});
        commonQueryParams.push({name: "recordId",value: stageGuideId});
            ...
            if(id){
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: 'post',
                            url: ctx+'/aea/par/stage/guide/delStageGuideAttFile.do',
                            dataType: 'json',
                            data: {'detailId': id, 'type': showGuideBasicType, 'guideId': stageGuideId},
