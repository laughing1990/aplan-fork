...
<body>
                ...
                <div class="m-portlet__body" style="padding: 10px 0px;">
                    ...
                    <div class="base" style="padding: 0px 5px;">
                        <table id="service_window_table"
                               ...
                               data-url="${pageContext.request.contextPath}/aea/par/stage/listStageWindowByPage.do?stageId=${recordId}">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="_operator" data-formatter="operatorFormatter" data-align="left" data-colspan="1">操作</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <%@include file="../../../item/guide/select_service_window.jsp"%>
    <script src="${pageContext.request.contextPath}/ui-static/aplanmis/par/stage/ui-js/stage_wind_rel_index.js" type="text/javascript"></script>
</body>
</html>