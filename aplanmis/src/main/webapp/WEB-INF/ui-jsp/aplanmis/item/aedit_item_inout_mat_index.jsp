...
<style type="text/css">
    ...
    #aedit_item_inout_mat_scroll::-webkit-scrollbar{
        width:4px;
        height:4px;
    }

    #aedit_item_inout_mat_scroll::-webkit-scrollbar-track{
        background: #fff;
        border-radius: 2px;
    }

    #aedit_item_inout_mat_scroll::-webkit-scrollbar-thumb{
        background: #e2e5ec;
        border-radius:2px;
    }

    #aedit_item_inout_mat_scroll::-webkit-scrollbar-thumb:hover{
        background: #aaa;
    }

    #aedit_item_inout_mat_scroll::-webkit-scrollbar-corner{
        background: #fff;
    }
</style>

<!-- 新增/编辑阶段材料信息 -->
<div id="aedit_item_inout_mat_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="aedit_item_inout_mat_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header" style="padding: 15px;height: 45px;">
                <h5 id="aedit_item_inout_mat_modal_title" class="modal-title"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="aedit_item_inout_mat_form" method="post" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 10px;">
                    <div id="aedit_item_inout_mat_scroll" style="height: 500px;overflow-x: hidden;overflow-y: auto;">
                ...
                <div class="modal-footer" style="padding: 10px;">
                    <button id="saveItemOutGlobalMatBtn"  type="submit" class="btn btn-info">保存</button>&nbsp;&nbsp;
                    <button type="button" class="btn btn-secondary"
                            onclick="$('#aedit_item_inout_mat_modal').modal('hide');">关闭</button>
                </div>
            </form>
        </div>
    </div>
