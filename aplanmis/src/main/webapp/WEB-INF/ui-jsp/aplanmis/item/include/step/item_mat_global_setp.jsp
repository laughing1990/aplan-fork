...
<div id="globalMatOperaDiv" class="m-portlet__body" style="padding: 10px 0px;max-height:350px;height:350px;verflow-y:auto;overflow-x: hidden">
    ...
    <div class="form-group m-form__group row" >
        ...
        <div class="col-lg-9">
            <div class="input-group">
                ...
                <textarea class="form-control" rows="3" id="global_mat_show_input" readonly="readonly"></textarea>
            </div>
        </div>
    </div>
</div>
