...
<head>
    ...
    <script type="text/javascript">
       var itemBasicId = '${itemBasic.itemBasicId}';
       var needCondType = '${itemBasic.needCondType}';
       var needCondNum = '${itemBasic.needCondNum}';
    </script>
</head>
<body>
    <div style="width: 100%;height: 100%; padding: 0px 10px 5px 10px;">
                        ...
                        <div class="col-xl-6 m--align-left m--padding-left-20">
                            ...
                            <label id="needCondNumLabel">
                                <input id="needCondNum" type="number" class="form-control m-input" style="width: 250px;"
                                       name="needCondNum" value="" placeholder="请输入至少满足条件数量" disabled="disabled"/>
                            </label>
                        </div>
                        <div class="col-xl-6">
                                            ...
                                            <table  id="view_item_cond_tb"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-field="isActive"   data-formatter="viewIsItemCondActiveStr"
    ...
    <!-- 业务js -->
    <script src="${pageContext.request.contextPath}/ui-static/aplanmis/item/ui-js/set_item_cond_index.js" type="text/javascript"></script>
</body>
</html>