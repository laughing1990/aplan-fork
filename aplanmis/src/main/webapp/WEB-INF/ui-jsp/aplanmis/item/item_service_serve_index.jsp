                ...
                <div class="m-form m-form--label-align-right m--margin-bottom-5">
                    <div class="row" style="margin: 0px;">
                        <div class="col-md-6"style="text-align: left;">
                            <button type="button" class="btn btn-info" onclick="addServiceServeItem();">新增</button>
                            <button type="button" class="btn btn-secondary" onclick="batchDeleteServiceServe();">删除</button>
                            <button type="button" class="btn btn-secondary" onclick="refreshServiceServeItem();">刷新</button>
                        </div>
                ...
                <div class="base" style="padding: 0px 5px;">
                    <table id="serviceServeTable"
                        ...
                        <tr>
                            ...
                            <th data-field="_operator" data-formatter="operatorFormatter" data-align="center" data-colspan="1" data-width="120">操作</th>
                        </tr>
                        </thead>
                    </table>
                </div>
