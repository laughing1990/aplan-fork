...
<div class="m-portlet m-portlet--mobile">
    <div class="m-portlet__body" id="pageBody">
        ...
        <form class="m-form m-form--fit m-form--label-align-right" style="margin-bottom: 10px" id="consultingForm">
            <div class="row">
                <div class="col-xl-7">
                </div>
                <div class="col-xl-5">
                    <div class="input-group">
                        ...
                        <input type="text" id="keyword" name="keyword" class="form-control" aria-label="Text input with dropdown button" placeholder="请输入服务咨询岗位查询">
                        <button type="button" class="btn btn-primary" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" onclick="searchServiceConsulting();">查询</button>&nbsp;
                        <button type="button" class="btn btn-default" onclick="clearSearchServiceConsulting();">清空</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="base" style="padding: 0px 5px;">
            <table id="serviceConsultingTable"
                   data-toggle="table",
                   ...
                   data-url="${pageContext.request.contextPath}/aea/item/service/consulting/viewListAeaItemServiceConsulting.do">
                <thead>
                <tr>
                    <th data-field="gwzzhqx" data-colspan="1" data-width="250" align="right">服务咨询岗位职责和权限</th>
                    <th data-field="zxgzcx" data-colspan="1" data-width="250" align="center">咨询工作程序</th>
                    <th data-field="dz" data-colspan="1" data-width="250" align="center">地址</th>

                    <th data-field="dh" data-colspan="1" data-width="250" align="right">电话号码</th>
                    <th data-field="hfsxhxs" data-colspan="1" data-width="250" align="center">回复时限及形式</th>
                    <th data-field="hfbm" data-colspan="1" data-width="250" align="center">回复部门</th>
                </tr>
                </thead>
            </table>
        </div>
...
<script>
    function dealQueryParams(params) {
        ...
        var d = {};
        var t = $('#consultingForm').serializeArray();
        $.each(t, function () {
    ...
    // 查询
    function searchServiceConsulting() {

        $('#serviceConsultingTable').bootstrapTable('refresh');
        $("#serviceConsultingTable").bootstrapTable('selectPage',1);
    }

    // 清空
    function clearSearchServiceConsulting(){

        $('#consultingForm')[0].reset();
        $('#serviceConsultingTable').bootstrapTable('refresh');
    }
</script>
