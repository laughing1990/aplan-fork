...
public class EffiJumpPageIndexController {
    ...
    public ModelAndView itemToleranceAcceptIndex(@RequestParam(required = false ,value = "false") boolean entrust ) {
    ...
    public ModelAndView queryNeedCorrectTasksIndex(@RequestParam(required = false ,value = "false") boolean entrust ) {
    ...
    public ModelAndView queryUnConfirmItemCorrectTasksIndex(@RequestParam(required = false ,value = "false") boolean entrust) {
    ...
    public ModelAndView querySpecialProcedureTasksIndex(@RequestParam(required = false ,value = "false") boolean entrust) {
    ...
    public ModelAndView itemAgreeToleranceIndex(@RequestParam(required = false ,value = "false") boolean entrust) {
    ...
    public ModelAndView itemDisgreeIndex(@RequestParam(required = false ,value = "false") boolean entrust) {
    ...
    public ModelAndView itemOutScopeIndex(@RequestParam(required = false ,value = "false") boolean entrust) {
