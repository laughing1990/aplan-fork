...
public class AeaItemUserAdminController {
    ...
    @RequestMapping("/listAeaItemUser.do")
    public PageInfo<AeaItemUser> listAeaItemUser(AeaItemUser aeaItemUser, Page page) throws Exception {

        logger.debug("分页查询，过滤条件为{}，查询关键字为{}", aeaItemUser);
        return aeaItemUserService.listAeaItemUser(aeaItemUser,page);
    }
    ...
    */
    ...
    @RequestMapping("/deleteAeaItemUserById.do")
    public ResultForm deleteAeaItemUserById(String id) throws Exception{
